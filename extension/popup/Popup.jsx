...
export default function Popup() {
  ...
  async function promoteGuest(guestId) {
    const response = await send('guest:promote', { guestId });
    if (response) setState(response);
  }
    ...
    <main className="min-h-[540px] bg-slate-50 p-4">
      ...
      {!state.session ? (
        ...
        <section className="mt-5 space-y-4">
          ...
          <GuestList guests={state.guests} onRevoke={revokeControl} onPromote={promoteGuest} />
